...
const BentoGrid = () => {
  ...
  return (
    <div className="bg-black text-white p-4 font-sans relative md:w-5/6 min-h-screen mt-20 overflow-hidden">
      <div className="flex h-5/6 w-full items-center justify-center relative">
        <div className="grid grid-cols-1 gap-4 p-2 md:grid-cols-5 w-full">
          ...
          <div className="md:col-span-2 md:row-span-2 bg-black bg-opacity-30 backdrop-blur-lg rounded-2xl p-4 flex flex-col items-center justify-center border border-gray-800 group transition-all duration-300 ease-in-out hover:scale-95">
          ...
          {renderGridItem("OUR SERVICES", "md:col-span-1 md:row-span-1")}
          {renderGridItem(
            "laptop+mobile",
          ...
          {renderGridItem("Contact", "md:col-span-1 md:row-span-1")}
          {renderGridItem(
            "Team",
            "md:col-span-1 md:row-span-1",
          ...
          {renderGridItem(
            " Build your brand",
            "md:col-span-1 md:row-span-1 text-center"
          )}
        </div>
      </div>
      ...
      {isDetailView && (
        ...
        >
          <div className="bg-black p-8 rounded-lg w-[95%] h-full md:h-4/6 overflow-auto relative border border-gray-800">
            <button
